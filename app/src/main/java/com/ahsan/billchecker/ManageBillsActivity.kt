...
class ManageBillsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        title = getString(R.string.manage_saved_numbers)
        ...
        listView.setOnItemClickListener { _, _, position, _ ->
            ...
            if (entry.company != Company.LESCO && !hasSetupPage) {
                Toast.makeText(
                    this,
    ...
    inner class BillAdapter : BaseAdapter() {
        private var bills: List<BillEntry> = Storage.getBills(this@ManageBillsActivity)

        fun refresh() {
            bills = Storage.getBills(this@ManageBillsActivity)
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            val view = convertView ?: LayoutInflater.from(this@ManageBillsActivity)
